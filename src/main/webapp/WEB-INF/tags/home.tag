...
<script type="text/javascript"	src="<c:url value="/resources/js/summernote-zh-CN.js"/>"></script>
...
<body>
	<div id="wrap">
		...
		<div style="padding-top: 20px; text-align: center;">
			<%-- <a id="go-back-home" href="/"> <img
				src="<c:url value="/resources/img/avatar.png"/>" alt="Home"
				width="53" height="59">
			</a> --%>
			<div class="imgtest">
				<figure>
